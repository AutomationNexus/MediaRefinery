...
class RawModelOutput:
    ...
    def __post_init__(self) -> None:
        """Normalize ``raw_labels`` from ``raw_label`` when omitted."""
        if self.raw_labels:
            return
...
class ClassificationResult:
    """Represent ClassificationResult.
...
class ConfiguredClassifier:
    """Represent ConfiguredClassifier."""
...
# Late import: avoids a circular import with classifier base classes.
from .onnx_backend import OnnxClassifierBackend  # noqa: E402
