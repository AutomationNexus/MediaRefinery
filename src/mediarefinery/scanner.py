...
class AssetScanner:
    ...
    def __init__(
        ...
        config : AppConfig
        client : ImmichClient
        state : ProcessingState | None, optional
        """
        self._client = client
