...
class StateStore:
    ...
    def start_run(
        ...
        *,
        ...
        dry_run : bool
        command : str
        config_snapshot_id : int | None, optional
        model_version_id : int | None, optional
    ...
    def record_model_version(
        ...
        *,
        ...
        model_identity_hash : str | None, optional
    ...
    def needs_processing(self, asset: AssetRef, *, reprocess: bool = False) -> bool:
        ...
        if stored_checksum is None:
            return True
        return bool(stored_checksum != asset.checksum)
    ...
    def get_config_snapshot_by_hash(self, config_hash: str) -> sqlite3.Row | None:
        """Return config snapshot by hash.
