"""Observability for MediaRefinery."""
...
def log_event(
    ...
    *,
    ...
    event : str
    level : int, optional
    asset_id : object | None, optional
    category_id : object | None, optional
    action_name : object | None, optional
    duration_ms : int | None, optional
    error_code : object | None, optional
